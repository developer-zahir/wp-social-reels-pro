	...
	protected function register_carousel_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description'  => esc_html__( 'Automatically transitions slides. If Infinite Loop is OFF, slider smoothly rewinds to Item 1 when reaching the end and continues playing.', 'wp-social-reels-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wp-social-reels-pro' ),
				'label_off'    => esc_html__( 'No', 'wp-social-reels-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'  => esc_html__( 'Seamless continuous infinite carousel without visible reset. When OFF, slider rewinds cleanly back to the beginning.', 'wp-social-reels-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wp-social-reels-pro' ),
				'label_off'    => esc_html__( 'No', 'wp-social-reels-pro' ),
				'return_value' => 'yes',
			...
			<?php if ( $is_carousel ) : ?>
				<?php if ( $is_hover_mode ) : ?>
					<style>
						...
						#wpsr-reels-<?php echo esc_attr( $widget_id ); ?> .wpsr-carousel-container:hover .wpsr-nav-arrow.swiper-button-disabled,
						#wpsr-reels-<?php echo esc_attr( $widget_id ); ?> .wpsr-carousel-container:hover .wpsr-nav-arrow:disabled,
						.elementor-element-<?php echo esc_attr( $widget_id ); ?>:hover .wpsr-nav-arrow.swiper-button-disabled,
						.elementor-element-<?php echo esc_attr( $widget_id ); ?>:hover .wpsr-nav-arrow:disabled {
				...
				<?php endif; ?>
				<div class="swiper wpsr-carousel-container wpsr-arrows-vis-<?php echo esc_attr( $arrows_visibility ); ?><?php echo $is_hover_mode ? ' wpsr-arrows-on-hover' : ''; ?>" data-arrows-vis="<?php echo esc_attr( $arrows_visibility ); ?>">
